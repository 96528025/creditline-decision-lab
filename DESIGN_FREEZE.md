...
**Status: FROZEN as of 2026-07-21, before any model or experiment code was written.**
...
Enforced by assertions in the pipeline scripts, in this order:
...
6. Policy work obeys the S3 boundaries; POLICY-TEST is read exactly once.
